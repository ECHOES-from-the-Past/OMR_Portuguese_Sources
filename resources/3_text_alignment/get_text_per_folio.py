...
def retrieve_text(csvpath):
    ...
    mss_text.pop("Folio")
    for page in mss_text.keys():
        with open(os.path.join(csvpath[0:-4], page + '.txt'), mode='w') as file:
            file.write(mss_text[page])
...
if __name__ == "__main__":
    ...
    parser.add_argument('cantusdb_csvfile', help="Cantus Database CSV file from which the text of the chants on each folio is extracted. (Remember to provide the '.csv' extension.)")
